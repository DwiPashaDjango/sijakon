...
@section('content')
    <div class="row">
        <div class="col-lg-12 mb-3">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#action" data-bs-title="Tambah Data Material" data-bs-action="create" data-bs-id=""><i class="las la-plus-circle"></i> Tambah</button>
        </div>
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-condensed table-bordered table-sm" id="material">
                            <thead>
                                <tr>
                                    <th>Nama Material</th>
                                    <th>Jenis</th>
    ...
    <x-dashboard.modal id="action" class="modal-lg">
        <form id="submit">
            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis" id="jenis" class="form-control jenis" autocomplete="off" placeholder="Jenis Material">
            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <div class="form-group">
                        <label for="harga" class="form-label">Harga Material</label>
                        <input type="text" name="harga" id="harga" class="form-control harga" autocomplete="off" placeholder="Harga Material">
...
@section('javascript')
    <script type="text/javascript">
        class Material extends App {
            ...
            get() {
                this.materials = $(`table#material`).laravelTable({
                    url: `${ this.baseUrl }/api/material`,
                    headers: {
                        ...
                        @if(role("Admin"))
                            {
                                ...
                                html: e => {
                                    return `
                                        <div class="btn-group">
                                            <a class="btn btn-primary btn-sm btn-icon update" href="javascript:;" data-bs-toggle="modal" data-bs-target="#action" data-bs-action="update" data-bs-title="Edit Material" data-bs-id="${ e.id }"><i class="ri-edit-2-line"></i></a>
            ...
            submit(e) {
                ...
                let url = `/api/material/store`

                if (action == `update`) {
                    url = `/api/material/${ id }/update`
